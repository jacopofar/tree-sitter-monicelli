...
module.exports = grammar({
  ...
  rules: {
    ...
    number: $ => /\d+/,
    operator_arithmetic: $ => choice('più', 'meno', 'per', 'diviso'),
    operator_bitwise: $ => seq('con scappellamento a', choice('destra', 'sinistra'), 'per'),
    ...
    expression: $ => choice(
      ...
      field('op_and_operands_arithmetic',
        prec.left(5, seq(field('left', $.expression), $.operator_arithmetic, field('right', $.expression))),
      ),
      field('op_and_operands_bitwise',
        prec.left(5, seq(field('left', $.expression), $.operator_bitwise, field('right', $.expression))),
      ),
